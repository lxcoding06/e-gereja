    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                    <form action="<?php echo base_url(). 'Data_Kematian/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12">
								...
								<div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="lg_kematian">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Waktu</label>
                                        <input class="form-control" type="time" value="" name="waktu_kematian">
                                    </div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group">
										...
										<div class="profile-upload">
                                            ...
                                            <img id="preview" src="#" alt="Pratinjau Gambar" style="display: none; max-width: 350px;">
											</div>
										</div>
									</div>
                                </div>
