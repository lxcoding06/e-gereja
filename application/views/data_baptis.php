            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Data Baptis</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                    <form action="<?php echo base_url(). 'Data_Baptis/tambah_aksi'; ?>" method="post">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nama Anak <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" value="" name="nama_anak">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="" name="tp_lahir">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                        <input type="text" class="form-control datetimepicker" name="lg_lahir">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                        <input type="text" class="form-control datetimepicker" name="lg_baptis">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="" name="ayah">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nama Ibu <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" value="" name="ibu">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Saksi Baptis</label>
                                        <input type="text" class="form-control" value="" name="saksi">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Petugas Baptis</label>
                                        <input type="text" class="form-control" value="" name="petugas">
                                    </div>
                                </div>
                            </div>
