            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Data Jemaat</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                    <form action="<?php echo base_url(). 'Data_Jemaat/tambah_aksi'; ?>" method="post">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>No Hp</label>
                                        <input type="tel" class="form-control" value="" name="no_hp">
                                    </div>
                                </div>
								<div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Username <span class="text-danger">*</span></label>
                                        <input class="form-control" type="tel" value="" name="username">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
