            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="data_jemaat" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                </div>
				<div class="row">
                <div class="col-sm-4 col-3">
									...
									<tr>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="<?php echo base_url(). 'detail_jemaat/lihat/'.$jm->id,''; ?>"><i class="fa fa-eye m-r-5"></i> Detail</a>
													<a class="dropdown-item" href="<?php echo base_url(). 'update_jemaat/edit/'.$jm->id,''; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a class="dropdown-item" href="<?php echo base_url(). 'Data_Jemaat/hapus/'.$jm->id,''; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
