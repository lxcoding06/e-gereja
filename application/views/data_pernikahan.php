    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                    <form action="<?php echo base_url(). 'Data_Pernikahan/tambah_aksi'; ?>" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Nama Calon Suami <span class="text-danger">*</span></label>
                                        <input class="form-control" name="calon_suami" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Tempat Lahir <span class="text-danger">*</span></label>
                                        <input class="form-control" name="tp_csuami" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" name="lg_csuami" class="form-control datetimepicker">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="calon_istri" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Tempat Lahir <span class="text-danger">*</span></label>
                                        <input class="form-control" name="tp_cistri" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Tanggal Lahir <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input type="text" name="lg_cistri" class="form-control datetimepicker">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lg_pernikahan" class="form-control datetimepicker">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Saksi 1 <span class="text-danger">*</span></label>
                                        <input class="form-control" name="saksi1" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Saksi 2 <span class="text-danger">*</span></label>
                                        <input class="form-control" name="saksi2" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                        <label>Petugas</label>
                                        <input type="text" name="petugas" class="form-control" value="">
                                    </div>
                            </div>
