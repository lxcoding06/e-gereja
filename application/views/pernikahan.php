            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Pernikahan</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="data_pernikahan" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                </div>
				<div class="row">
                <div class="col-sm-4 col-3">
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
                                <?php 
		                        foreach($pernikahan as $pr){ ?>
									<tr>
										<td><?php echo $pr->calon_suami ?></td>
										<td><?php echo $pr->calon_istri ?></td>
										<td><?php echo $pr->saksi1 ?></td>
										<td><?php echo $pr->saksi2 ?></td>
										<td><?php echo $pr->petugas ?></td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="<?php echo base_url(). 'update_pernikahan/edit/'.$pr->id,''; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a class="dropdown-item" href="<?php echo base_url(). 'Data_Pernikahan/hapus/'.$pr->id,''; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
